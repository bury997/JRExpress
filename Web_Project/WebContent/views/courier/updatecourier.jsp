...
<head>
	...
	function updateCourier() {
		layer.load();
		var cName = $("input:eq(2)").val();
		var newCphone = $("input:eq(3)").val();
		var cCard = $("input:eq(4)").val();
		var cPass = $("input:eq(5)").val();
		var sex = $("input:eq(6)").val();
		$.getJSON("../../courierUpdate.do","cPhone="+cPhone+"&cName="+cName+"&cPhone="+newCphone+"&cCard="+cCard+"&cPass"+cPass+"&sex"+sex,function(data){
			layer.closeAll();
			layer.msg(data.msg);
			if(data.status==0){
				$("#content").fadeOut(2000);
    ...
    <div class="layui-content">
    	<div class="layui-row">
            <div class="layui-card">
                <div class="layui-card-header">修改快递员</div>
                <form class="layui-form layui-card-body" action="">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                     ...
                     <div class="layui-input-inline">
                      <input onclick="find()" value="立即查找" type="button" class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo">
                    </div>
                  </div>
                </form>  
            </div>
        ...
        <div class="layui-row" id="content" style="display: none;">
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" action="">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      <input onclick="updateCourier" type="button" value="确认修改" class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo">
