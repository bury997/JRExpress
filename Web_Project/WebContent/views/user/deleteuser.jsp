...
<head>
    ...
    <script type="text/javascript" src="../../js/jquery.js"></script>
     <script type="text/javascript">
    	...
    	function del() {
			layer.load();
			$.get("../../deleteUser.do","uPhone"=uPhone,function(data){
				layer.closeAll();
				layer.msg(data.msg);
				if(data.status==0){
					$("#content").fadeOut(2000);
                ...
                <form class="layui-form layui-card-body" action="">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                     ...
                     <div class="layui-input-inline">
                      <input onclick="find()" value="立即查找"  class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo" type="button">
                    </div>
                  </div>
                </form>  
            </div>
        ...
        <div class="layui-row" id="content" style="display: none;">
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" action="">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      <input onclick="del()" value="确认删除"  class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo" type="button">
