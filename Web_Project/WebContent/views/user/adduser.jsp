...
<head>
    ...
    <script type="text/javascript">
    	function add() {
			...
			layer.load();
			$.getJSON("../../insertUser.do","uName="+uName+"&uPhone="+uPhone+"&uPass="+uPass+"&uSex="+uSex,function(data){
				layer.closeAll();
				layer.msg(data.msg);
				if(data.status==0){
        ...
        <div class="layui-row">
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" action="">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      <input type="button" value="立即提交" onclick="add()" class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo">
