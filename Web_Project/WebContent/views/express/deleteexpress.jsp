...
<head>
    ...
    <script type="text/javascript">
    	...
    	function deleteExpress() {
			layer.load();
			$.getJSON("../../expressDelete.do","eNumber="+eNumber,function(data){
				layer.closeAll();
				layer.msg(data.msg);
				if(data.status==0){
					$("#content").fadeOut(2000);
    ...
    <div class="layui-content">
    	<div class="layui-row">
            <div class="layui-card">
                <div class="layui-card-header">删除快件信息</div>
        ...
        <div class="layui-row" id="content" style="display:none;">
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" action="">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      <input onclick="deleteExpress()" class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo" value="确认删除">
