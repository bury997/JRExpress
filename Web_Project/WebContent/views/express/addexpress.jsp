...
<body class="layui-view-body">
        ...
        <div class="layui-row">
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" action="">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      <input onclick="insert()" class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo" value="立即提交">
    ...
    <script type="text/javascript">
    	function insert() {
			var eNumber = $("input:eq(0)").val();
			if(eNumber.length>32){
				layer.msg("单号长度不符,请检查");
				return;
			}
			...
			layer.load();
			$.getJSON("../../expressInsert.do","eNumber="+eNumber+"&company="+company+"&userName="+userName+"&userPhone="+userPhone,function(data){
				layer.closeAll();
				layer.msg(data.msg);
				if(data.status==0){
